...
public final class AMOApplication<T extends Application>
    ...
    public AMOResult execute(Command command) {
        ...
        // Your code here...
        clientToSequenceNumMap.put(amoCommand.address(), amoCommand.sequenceNum());
    ...
    public boolean alreadyExecuted(AMOCommand amoCommand) {
        // Your code here...
        return clientToSequenceNumMap.containsKey(amoCommand.address())
                && clientToSequenceNumMap.get(amoCommand.address()) >= amoCommand.sequenceNum();
    }
}
